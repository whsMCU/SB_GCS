...
namespace SB_GCS.Class
{
    public class MspProtocol
    {
        ...
        static readonly int INBUF_SIZE = 256;
        ...
        private static readonly String MSP_HEADER = "$M<";
    ...
    public List<char> payload;
        ...
        public float[] byteP = new float[3], byteI = new float[3], byteD = new float[3],
                byteP_outer = new float[3], byteI_outer = new float[3], byteP_inner = new float[3], byteI_inner = new float[3], byteD_inner = new float[3],
                byteP_rate = new float[3], byteI_rate = new float[3], byteD_rate = new float[3];
        ...
        public List<Byte> requestMSP(int msp, char[] payload)
        {
            ...
            byte checksum = 0;
            byte pl_size = (byte)(payload != null ? payload.Count() : 0);
            bf.Add(pl_size);
